                         ...
                         <div className="space-y-2 max-h-[60vh] overflow-y-auto pr-2 custom-scrollbar">
                             ...
                             {/* Genel Analiz Butonu */}
                              <button
                                     ...
                                     className={`w-full text-left p-4 rounded-lg transition-all duration-200 mt-4 border-2 ${
                                         selectedSinav === null 
                                             ...
                                             <div key={i} className="bg-gray-700/50 p-3 rounded-lg flex flex-col md:flex-row justify-between items-start md:items-center border border-gray-600 gap-2">
                                                 ...
                                                 <div className="flex items-center gap-4 text-sm">
                                                     ...
                                                     <div className={`px-2 py-1 rounded font-bold ${
                                                         konu.basariYuzdesi >= 80 ? 'bg-green-500/20 text-green-400' :
